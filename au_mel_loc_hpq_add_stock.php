...
<body>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="boxdiv">
         	<label for="email"> quantity being added </label>
  ...
  <div class="boxdiv">
	 ...
	 <br>
	  <button type="submit" name="search" class="btn btn-primary">Add To The Stock</button>
...
echo '<script>alert("Part has been added to the stock")</script>';
if(strlen($ewo)>0){
  // check with team for wo length
  mysqli_query($link,"insert into au_mel_all_out_history values(NULL,'$_POST[wo]','$_POST[activeresource]','$epart_no','$eroom_no','$estock_count','$_POST[need]','$add_to_mark',CURRENT_TIMESTAMP)");
   echo "done";
   ?>
			<script type="text/javascript">
			window.location="au_mel_loc_hpq.php";
			</script>
			<?php
}
